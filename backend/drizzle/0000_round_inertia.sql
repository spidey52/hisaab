...
--> statement-breakpoint
CREATE TABLE "contact_discovery_usage" (
	"user_id" text NOT NULL,
	"window_start" timestamp with time zone NOT NULL,
	"request_count" integer DEFAULT 0 NOT NULL,
	"phone_count" integer DEFAULT 0 NOT NULL,
	CONSTRAINT "contact_discovery_usage_user_id_window_start_pk" PRIMARY KEY("user_id","window_start")
);
--> statement-breakpoint
...
CREATE TABLE "operation_receipts" (
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "operation_receipts_company_id_operation_id_pk" PRIMARY KEY("company_id","operation_id")
);
--> statement-breakpoint
...
CREATE TABLE "sync_changes" (
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "sync_changes_change_type_check" CHECK ("sync_changes"."change_type" in ('upsert', 'tombstone'))
);
--> statement-breakpoint
...
CREATE TABLE "users" (
	...
	"contact_discoverable" boolean DEFAULT false NOT NULL,
	"version" bigint DEFAULT 1 NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
...
ALTER TABLE "contact_discovery_usage" ADD CONSTRAINT "contact_discovery_usage_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "operation_receipts" ADD CONSTRAINT "operation_receipts_company_id_companies_id_fk" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "sync_changes" ADD CONSTRAINT "sync_changes_company_id_companies_id_fk" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "contact_discovery_usage_window_idx" ON "contact_discovery_usage" USING btree ("window_start");--> statement-breakpoint
...
CREATE UNIQUE INDEX "entries_one_active_opening_balance_uq" ON "entries" USING btree ("company_id","party_id") WHERE "entries"."action" = 'opening_balance' and "entries"."status" = 'posted';--> statement-breakpoint
...
CREATE INDEX "operation_receipts_created_idx" ON "operation_receipts" USING btree ("created_at");--> statement-breakpoint
...
CREATE INDEX "parties_company_phone_e164_idx" ON "parties" USING btree ("company_id","phone_e164") WHERE "parties"."phone_e164" is not null;--> statement-breakpoint
...
CREATE INDEX "sync_changes_company_id_idx" ON "sync_changes" USING btree ("company_id","id");--> statement-breakpoint
CREATE INDEX "sync_changes_entity_idx" ON "sync_changes" USING btree ("company_id","entity_type","entity_id","id");--> statement-breakpoint
